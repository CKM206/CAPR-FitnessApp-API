 ...
 */
 ...
 router.get('/exercises', GetExercises);        // Get all Exercises
 router.get('/exercise/:exerciseId', GetExercises);   // Get A single Exercise

  /**
  * POST Requests
  */

 router.post('/exercises', NewExercise);        // Create a single Exercise

  /**
  * UPDATE Requests
  */

 router.put('/exercises/:id', UpdateExercise);                 // Update a single Exercise
 
 
  /**
  * DELETE Requests
  */
   router.delete('/exercises/:exerciseId', DeleteExercise);            // Delete a single Exercise