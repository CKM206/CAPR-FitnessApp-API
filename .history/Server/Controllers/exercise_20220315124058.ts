 ...
 */
 ...
 export function NewExercise(req:Request, res:Response, next:NextFunction): Response
 {
     console.log(req.body);
     const newExercise = req.body;
    
     // Check if some required Properties are missing
     if (!newExercise.name || !newExercise.exerciseType || !newExercise.setType || !newExercise.hasOwnProperty('default') || newExercise.default === null)
     {
        return res.status(422).send({ error: 'Must Provide Exercise Name, Type, and Default Status' });
     }     
